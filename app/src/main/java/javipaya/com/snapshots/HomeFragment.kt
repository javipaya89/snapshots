package javipaya.com.snapshots
...
import javipaya.com.snapshots.databinding.FragmentHomeBinding
import javipaya.com.snapshots.databinding.ItemSnapshotBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.i("Firebase","onViewCreated")
        val query = FirebaseDatabase.getInstance().reference.child("snapshots")

        Log.d("Firebase",query.toString())
        ...
        mFirebaseAdapter = object : FirebaseRecyclerAdapter<Snapshot, SnapshotHolder>(options){
            ...
            override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SnapshotHolder {
                ...
                Log.i("Firebase","onCreateViewHolder")
            ...
            override fun onBindViewHolder(holder: SnapshotHolder, position: Int, model: Snapshot) {
                ...
                Log.i("Firebase","onBindViewHolder")
